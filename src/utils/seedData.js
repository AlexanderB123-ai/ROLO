...
export const seedContacts = [
  ...
  },
  {
    ...
    open_threads: ["Congratulate on Columbia Law acceptance"],
    life_updates: ["Got into Columbia Law", "Starting this fall", "Looking for apartments near campus"],
  ...
  },
  {
    ...
    open_threads: ["Plan dinner together next week"],
    life_updates: ["Got promoted to head trainer", "Thinking about starting own fitness business"],
  ...
  },
  {
    ...
    open_threads: ["Ask about the design project for tech startup", "See if she needs help with portfolio website"],
    life_updates: ["Got a big client - tech startup rebrand", "Planning trip to Japan in summer"],
    tags: ["Family", "Sister"],
    importance: 5,
    created_at: Date.now(),
    interactions: [
  ...
  },
  {
    ...
    open_threads: ["Ask how the migration project is going"],
    life_updates: ["Leading database migration project", "Thinking about switching teams"],
    tags: ["Work", "Colleague"],
    importance: 3,
    created_at: Date.now(),
    interactions: [
  ...
  },
  {
    ...
    open_threads: ["Check in about med school exams", "Try that new Thai restaurant she mentioned"],
    life_updates: ["Finishing second year of med school", "Considering specializing in pediatrics", "Started teaching yoga on weekends"],
    tags: ["College", "Friend"],
    importance: 4,
    created_at: Date.now(),
    interactions: [
  ...
  },
  {
    ...
    open_threads: ["Ask about the EP recording", "Plan to catch another show"],
    life_updates: ["Band is recording first EP", "Got engaged to Lisa", "Looking for bigger venue for shows"],
  ...
  },
  {
    ...
    open_threads: ["Send update on job search", "Ask for recommendation letter"],
    life_updates: ["Published new book on AI ethics"],
  ...
  },
  {
    ...
    birthday: daysFromNow(10),
    significant_other: null,
    last_interaction: {
      approximate_date: daysAgo(20),
      description: "Went to dance class together"
    },
    open_threads: ["Plan birthday celebration"],
    life_updates: ["Got promoted to senior buyer", "Planning trip to Paris Fashion Week"],
    tags: ["Dance", "Friend"],
    importance: 3,
    created_at: Date.now(),
    interactions: [
